	...
	<div className='rounded-xl relative w-full'>
		...
		<div className='absolute w-full h-full bg-black/30 rounded-xl text-white'>
			<div className='flex flex-col justify-evenly items-center h-full'>
				...
				<NavLink to={`pet/${elementId}`} className='border-white bg-white text-center text-black bottom-4 rounded-xl font-bold h-[35px] w-32 text-[15px] sm:w-40 sm:text-[2.8vw] md:text-[2.2vw] md:w-44 lg:text-[20px] lg:w-156px'>{buttonLabel}</NavLink>
			</div>
		</div>
