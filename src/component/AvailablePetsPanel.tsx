...
export const AvailablePetsPanel = () => {
	...
	return (
		...
		>
			...
			<motion.div variants={FM_SHOW_FROM_LEFT}>
				<PetWrapper className="min-w-[150px] max-w-[15vw] h-[150px] bg-white flex justify-evenly flex-col items-center hover:bg-[#efeef1] hover:border hover:border-primary shadow-xl rounded-2xl sm:h-[130px] hover:cursor-pointer">
