...
const HeadLinesCards = () => (
	<div className='max-w-[1880px] min-w-[100px] mx-auto p2 p-4 py-8 grid justify-center sm:grid-cols-3 gap-6 bg-red-300 sm:bg-yellow lg:bg-blue-800 select-none'>
		{/* Cards */}
